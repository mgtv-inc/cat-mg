...
<div id="navbar" class="navbar navbar-default">
    ...
    <div class="sidebar" style="height: 54px;line-height: 54px;">
        <img src="${model.webapp}/images/logo1.png" height="32" width="120"
    ...
    <div class="main-container">
        <div class="navbar-container" id="navbar-container">
            ...
            <!-- /section:basics/sidebar.mobile.toggle -->
            <div class="navbar-header pull-left" id="sidebar-collapse" style="margin-top: 10px;">
                <!-- #section:basics/navbar.layout.brand -->
                <span class="global-header-index-trigger">
                        ...
                        <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                            <li>
                                <a id="nav_application">
                                    <i class="ace-icon fa fa-signal"></i>应用监控
                                </a>
                            </li>
                            <li>
                                <a id="nav_config">
                                    <i class="ace-icon fa fa-cogs"></i>配置管理
                                </a>
                            </li>
                            <li>
                                <a id="nav_document">
                                    <i class="ace-icon fa fa-cogs"></i>说明文档
                                </a>
                            </li>
                            <li>
